...
<template>
    <div
        class="w-full xl:inline-block xl:hover:bg-gray-100 p-2 rounded-full transition duration-300 ease-in-out"
    >
        <div class="flex items-center">
            ...
            <span
                class="xl:block hidden text-black font-extrabold text-[18px] pl-2 mt-0.5 cursor-pointer"
            >
                {{ iconString }}
            </span>
        </div>
