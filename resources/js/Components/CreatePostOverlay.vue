...
import MapMarketOutline from "vue-material-design-icons/MapMarkerAccountOutline.vue";
...
const getUploadedImage = (e) => {
    ...
    console.log(e.target.files[0], fileDisplay, isValidFile);
    setTimeout(() => {
        document
            ...
            >
                ...
                >
                    ...
                    >
                        <label
                            for="file"
                            class="hover:bg-blue-700 rounded-lg p-2.5 text-white font-extrabold cursor-pointer"
                        >
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    ...
                    <div class="flex w-full ma-h-[200px] bg-white border-b">
                        <textarea
                            ref="textarea"
                            v-model="form.text"
                    ...
                    <div
                        class="flex items-center justify-between border-b border-b-gray-80 p-3"
                    >
                        <div class="text-lg font-extrabold text-gray-500">
                            Add Location
                        </div>
                        <MapMarketOutline :size="27" />
                    </div>
                    <div
                        class="flex items-center justify-between border-b border-b-gray-80 p-3"
                    >
