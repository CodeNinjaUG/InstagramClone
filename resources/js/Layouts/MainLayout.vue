...
<template>
    <div id="MainLayout" class="w-full h-screen">
        ...
        <div
            id="SideNav"
            class="fixed h-full bg-white w-[80px] xl:w-[280px] md:block hidden border-r border-r-gray-300"
        >
            <Link href="/">
                <img
            ...
            <Link href="/" class="absolute bottom-0 px-3 w-full">
                <MenuItem iconString="Logout" class="mb-4"></MenuItem>
            </Link>
        </div>
        <div
            ...
            >
                ...
                <div class="max-w-[300px] mt-5">
                    <div class="text-sm text-gray-400">
                        Nullam malesuada dui sodales nibh vehicula dapibus.
                        Aliquam quis pulvinar lacus. Morbi id nisl ut mi
                        vestibulum faucibus. Cras finibus libero at velit semper
                        fermentum
                    </div>
